...
public class MainActivity extends AppCompatActivity {
    ...
    public void Klik (View view){
        ...
        ImageButton btnKanan = (ImageButton) findViewById(R.id.btnKanan);
        ImageButton btnKiri = (ImageButton) findViewById(R.id.btnKiri);
        ImageButton btnAtas = (ImageButton) findViewById(R.id.btnAtas);
        ImageButton btnBawah = (ImageButton) findViewById(R.id.btnBawah);
